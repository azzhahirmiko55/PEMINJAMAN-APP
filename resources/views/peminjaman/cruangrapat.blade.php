            ...
            <div class="nk-content-body">
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        ...
                        <div class="nk-block-head-content">
                            <a href="#" onClick="showFormPeminjaman()" class="btn btn-primary"><em
                                    class="icon ni ni-plus"></em><span>Tambah Data Pemijaman</span></a>
                        </div><!-- .nk-block-head-content -->
                    ...
                    <div class="row gx-4 gy-3">
                        <div class="col-sm-8">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    ...
                                    {{-- <input type="text" name="peminjam" class="form-control" id="id-peminjam"
                                        placeholder="Peminjam" required> --}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    ...
                                    <input type="number" name="jumlah_peserta" class="form-control"
                                        id="id-jumlah-peserta" placeholder="Jumlah Peserta" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    ...
                                    <input type="text" name="tanggal" id="id-tanggal-peminjaman" class="form-control"
                                        data-date-format="yyyy-mm-dd" value="{{ date('Y-m-d') }}" required readonly>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="w-50">
                                        <div class="form-control-wrap">
                                            ...
                                            <input type="text" name="start_time" id="event-start-time"
                                                data-time-format="HH:mm" class="form-control" required readonly>
                                        </div>
                                    </div>
                                    <div class="w-50">
                                        <div class="form-control-wrap">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    ...
                                    <textarea class="form-control" name="keperluan" id="id-keperluan"
                        ...
                        <div class="col-12">
                            <ul class="d-flex justify-content-between gx-4 mt-1">
                                <li>
                                    <button id="btn-simpan-peminjaman" type="submit" class="btn btn-primary"><em
                                            class="icon ni ni-save"></em><span>Simpan Data</span></button>
                                </li>
                                <li>
