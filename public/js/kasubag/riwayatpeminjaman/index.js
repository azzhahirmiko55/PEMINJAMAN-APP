...
const loadCalendar = () => {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        events: "/getDataKasubagPeminjaman",
        eventDisplay: "none",
        height: 800,
        contentHeight: 780,
        aspectRatio: 3,
...
async function showInfoPengembalian(ds) {
    ...
    try {
        const res = await $.getJSON("/getDataKasubagPeminjaman", {
            tanggal: ds,
        });
